package com.dmi.util.android.setting
...
class DBSettings(
    ...
    private fun <T> setInt(key: Key<T>, value: Long) {
    ...
    private fun <T> setReal(key: Key<T>, value: Double) {
    ...
    private fun <T> setText(key: Key<T>, value: String) {
    ...
    private fun <T> getInt(key: Key<T>) = values[key.name]?.intValue
    private fun <T> getReal(key: Key<T>) = values[key.name]?.realValue
    private fun <T> getText(key: Key<T>) = values[key.name]?.textValue
