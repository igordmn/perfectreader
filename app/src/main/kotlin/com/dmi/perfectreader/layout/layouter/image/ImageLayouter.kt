...
import com.dmi.perfectreader.layout.layoutobj.LayoutImage
import com.dmi.perfectreader.layout.layouter.common.LayoutSize.Dimension.Auto
import com.dmi.perfectreader.layout.layouter.common.LayoutSize.Dimension.Fixed
import com.dmi.perfectreader.layout.layouter.common.LayoutSpace
import com.dmi.perfectreader.layout.layouter.Layouter
import com.dmi.perfectreader.layout.layouter.image.BitmapLoader.Companion.calculateInSampleSize
import com.dmi.perfectreader.layout.renderobj.RenderImage
        ...
        return object {
            fun layout(): RenderImage {
                try {
                    ...
                    return RenderImage(width, height, bitmap, obj.range)
                } catch (e: IOException) {
                    ...
                    return RenderImage(width, height, errorBitmap, obj.range)
                }
            }
