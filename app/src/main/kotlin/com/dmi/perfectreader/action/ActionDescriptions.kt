...
fun actionName(context: Context, id: ActionID): String = when (id) {
    ...
    ActionID.CHANGE_TEXT_COLOR_GAMMA -> settingActionName(context, SettingActionID.TEXT_COLOR_GAMMA)
    ActionID.CHANGE_TEXT_COLOR_CONTRAST -> settingActionName(context, SettingActionID.TEXT_COLOR_CONTRAST)
    ActionID.CHANGE_TEXT_COLOR_BRIGHTNESS -> settingActionName(context, SettingActionID.TEXT_COLOR_BRIGHTNESS)
    ...
    ActionID.INCREASE_TEXT_COLOR_GAMMA -> increaseActionName(context, SettingActionID.TEXT_COLOR_GAMMA)
    ActionID.INCREASE_TEXT_COLOR_CONTRAST -> increaseActionName(context, SettingActionID.TEXT_COLOR_CONTRAST)
    ActionID.INCREASE_TEXT_COLOR_BRIGHTNESS -> increaseActionName(context, SettingActionID.TEXT_COLOR_BRIGHTNESS)
    ...
    ActionID.DECREASE_TEXT_COLOR_GAMMA -> decreaseActionName(context, SettingActionID.TEXT_COLOR_GAMMA)
    ActionID.DECREASE_TEXT_COLOR_CONTRAST -> decreaseActionName(context, SettingActionID.TEXT_COLOR_CONTRAST)
    ActionID.DECREASE_TEXT_COLOR_BRIGHTNESS -> decreaseActionName(context, SettingActionID.TEXT_COLOR_BRIGHTNESS)
...
fun settingActionName(context: Context, id: SettingActionID): String = when (id) {
    ...
    SettingActionID.PAGE_MARGINS -> context.getString(R.string.actionChangePageMargins)
    SettingActionID.TEXT_SIZE -> context.getString(R.string.actionChangeTextSize)
    SettingActionID.TEXT_LINE_HEIGHT -> context.getString(R.string.actionChangeTextLineHeight)
    SettingActionID.TEXT_GAMMA -> context.getString(R.string.actionChangeTextGamma)
    SettingActionID.TEXT_COLOR_GAMMA -> context.getString(R.string.actionChangeTextColorGamma)
    SettingActionID.TEXT_COLOR_CONTRAST -> context.getString(R.string.actionChangeTextColorContrast)
    SettingActionID.TEXT_COLOR_BRIGHTNESS -> context.getString(R.string.actionChangeTextColorBrightness)
    SettingActionID.TEXT_STROKE_WIDTH -> context.getString(R.string.actionChangeTextStrokeWidth)
    SettingActionID.TEXT_SCALE_X -> context.getString(R.string.actionChangeTextScaleX)
    SettingActionID.TEXT_LETTER_SPACING -> context.getString(R.string.actionChangeTextLetterSpacing)
    SettingActionID.SCREEN_BRIGHTNESS -> context.getString(R.string.actionChangeScreenBrightness)
}
