...
import com.dmi.perfectreader.fragment.book.layout.layouter.paragraph.breaker.Breaker
import com.dmi.perfectreader.fragment.book.layout.layouter.paragraph.breaker.Breaks
import com.dmi.perfectreader.fragment.book.layout.layouter.paragraph.breaker.NoneBreaks
...
class BreakLinerTest {
    ...
    fun `apply hyphenation to breaker`() {
        ...
        // then
        breaker.config.hyphenation shouldEqual false

        // when
        liner.makeLines(measuredText("text"), config(300F, hyphenation = true))

        // then
        breaker.config.hyphenation shouldEqual true
    }
